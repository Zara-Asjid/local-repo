...
class RejectViewModel_Manager(application: Application) : AndroidViewModel(application) {



    private val repository = RejectRepository_Manager(RejectDataSource_Manager())
    ...
    fun getRejectLeaveStatus(context: Context, reject_leave_request : RejectLeaveByManagerRequest) = viewModelScope.launch {
