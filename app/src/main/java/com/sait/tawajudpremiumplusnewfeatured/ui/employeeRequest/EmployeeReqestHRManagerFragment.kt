package com.sait.tawajudpremiumplusnewfeatured.ui.employeeRequest
...
import com.sait.tawajudpremiumplusnewfeatured.databinding.FragmentHrManagerEmployeeRequestBinding
import com.sait.tawajudpremiumplusnewfeatured.ui.employeeRequest.hr.EmployeeReqestHrFragment
import com.sait.tawajudpremiumplusnewfeatured.ui.employeeRequest.manager.EmployeeReqestManagerFragment
import com.sait.tawajudpremiumplusnewfeatured.util.GlobalVariables
import com.sait.tawajudpremiumplusnewfeatured.util.extension.hasInternetConnection
import com.sait.tawajudpremiumplusnewfeatured.util.preferences.UserShardPrefrences

class EmployeeReqestHRManagerFragment: BaseFragment() , View.OnClickListener {

    private var _binding: FragmentHrManagerEmployeeRequestBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        _binding = FragmentHrManagerEmployeeRequestBinding.inflate(inflater, container, false)
    ...
    private fun setAdapters() {
        ...
        if(UserShardPrefrences.getisManager(mContext)) {
            adapter!!.addFragment(
                EmployeeReqestManagerFragment(),
                resources.getString(R.string.manager)
            )
        }
        if(UserShardPrefrences.getisHR(mContext)){
            adapter!!.addFragment(EmployeeReqestHrFragment(), resources.getString(R.string.hr))
      }


        binding.pagerHrManager.adapter = adapter
        binding.tabLayoutHrManager.setupWithViewPager(binding.pagerHrManager)
        binding.tabLayoutHrManager.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
