...
class ApproveManualEntryHRViewModel(application: Application) : AndroidViewModel(application) {



    private val repository = ApproveManualEntryHRRepository(ApproveManualEntryHRDataSource())
