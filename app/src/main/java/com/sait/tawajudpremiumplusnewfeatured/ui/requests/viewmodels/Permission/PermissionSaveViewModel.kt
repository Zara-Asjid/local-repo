...
import com.sait.tawajudpremiumplusnewfeatured.ui.requests.viewmodels.Permission.PermissionSaveRepository
import com.sait.tawajudpremiumplusnewfeatured.ui.requests.viewmodels.Permission.RequestSavePermissionDataSource
import com.sait.tawajudpremiumplusnewfeatured.util.extension.hasInternetConnection
import kotlinx.coroutines.launch
import retrofit2.Response
import java.io.IOException

class PermissionSaveViewModel(application: Application) : AndroidViewModel(application) {


    private val repository = PermissionSaveRepository(RequestSavePermissionDataSource())
