...
class Pending_Adapter_Manager(
    private var ListofLeaveRequest: ArrayList<pending_leaves_data>?,
    private var ListofPermissionRequest: ArrayList<PendingPermissionData>,
    private var ListofManualEntryRequest: ArrayList<PendingManualEntryData>,
    private val Listener: PendingLeaveApprovalListener_Manager,
    private var mContext: Context
) : RecyclerSwipeAdapter<Pending_Adapter_Manager.SimpleViewHolder>() {

    private var pendingPermissionRequestList: ArrayList<PendingPermissionData>? = null
    private var pendingLeaveRequestList: ArrayList<pending_leaves_data>? = null
    private var pendingManualRequestList: ArrayList<PendingManualEntryData>? = null
    ...
    override fun onBindViewHolder(viewHolder: SimpleViewHolder, position: Int) {
        if (pendingLeaveRequestList!!.size != 0) {
            ...
            val items: pending_leaves_data = pendingLeaveRequestList!![position]
        ...
        if (pendingPermissionRequestList!!.size != 0) {
            ...
            val items: PendingPermissionData = pendingPermissionRequestList!![position]
            ...
            if (items.days.toDouble() > 1) {
                ...
                //FormatingDate(items.permDate) + " - " + FormatingDate(items.permEndDate)
        ...
        if (pendingManualRequestList!!.size != 0) {
            ...
            viewHolder.l_to_time.visibility = View.GONE
            viewHolder.l_from_time.visibility = View.VISIBLE
            val itemPendingManualEntry: PendingManualEntryData =
