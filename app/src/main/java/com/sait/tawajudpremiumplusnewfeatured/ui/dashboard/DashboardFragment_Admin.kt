...
import com.sait.tawajudpremiumplusnewfeatured.databinding.FragmentDashboardBinding
...
class DashboardFragment_Admin : BaseFragment(), OnClickListener {
...
*/
    ...
    private fun getDashboardDetails() {
        ...
        val dashboardRequest = DashboardRequest(
            0, 0, 0, binding.txtFromDate.text.toString(),
            UserShardPrefrences.getLanguage(mContext)!!.toInt(),
            0, binding.txtToDate.text.toString(), UserShardPrefrences.getUserInfo(context).fKEmployeeId, 0
        )
 ...
 */
    ...
    private fun pickDate(day: Int, month: Int, year: Int, textView: TextView) {
        val datePickerFragment = DatePickerFragment.newInstance(year, month, day,textView.id,"DashboardFragment_Admin")
