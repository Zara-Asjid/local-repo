...
private var uploadFileStr:String? = null
    ...
    private fun initializeWebView() {
            ...
            if (UserShardPrefrences.getLanguage(mContext)=="0"){
                binding.webViewFragmentHelp.loadUrl("http://aman-me.com/privacy-policy-tawajud-mobile-app.php")
            }else
    ...
    override fun onResume() {
        ...
        (activity as MainActivity).show_app_title(mContext!!.resources.getString(R.string.privacy_policy))
